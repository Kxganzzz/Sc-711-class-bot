...
@${orang.split('@')[0]} â¤ï¸ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, jawab, 'Â@yudipermana', m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
let btn = [{
                                quickReplyButton: {
                                    displayText: 'Fianz Botz',
                                    id: 'owner'
                                }
                                }, {
                                quickReplyButton: {
                                    displayText: 'BOT yudi',
                                    id: 'owner'
                                }
                            }, {
                                quickReplyButton: {
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    ...
                    description: "*Aman Kok deckðŸ—¿ðŸ‘‡*",
                    buttonText: "All Menu",
                    footerText: "BOT YUDI NIH BANH",
                    ...
                    sections: [{
								...
								"rows": [
									{
										"title": "All Menu Bot",
										"description": "Selamat Memakai BANG ðŸ—¿",
...
â”‚âžª ${prefix}heleh
â”‚âžª ${prefix}holoh
â”‚âžª ${prefix}jadian [NOTE SATRYA JADIAN AMA DEVINA]
...
â”‚ âžª Runtime : ${runtime(process.uptime())}
â”‚ âžª Library : Baileys Multi Device
â”‚ âžª Deskripsi : Bot Ini Untuk Teman teman @yudi
â•°â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â
â•­â”€â *ã€Ž INFO SERVER ã€*
â”‚ âžª Tanggal : ${jangwak}
â”‚ âžª Waktu : ${time}
...
â”‚ âžª Runtime : ${runtime(process.uptime())}
â”‚ âžª Library : Baileys Multi Device
â”‚ âžª Deskripsi : Bot Ini Untuk teman-teman saya cuy yudi
â•°â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â
â•­â”€â *ã€Ž INFO SERVER ã€*
â”‚ âžª Tanggal : ${jangwak}
â”‚ âžª Waktu : ${time}
...
let btn = [{
                                urlButton: {
                                    displayText: 'Ownee Instagram¸',
                                    url: 'https://instagram.com/yudipermana.1'
                                }
                                }, {
                                urlButton: {
                                    displayText: 'Instagram Satrya',
...
4.  Jangan Report Error Males Coding
5.  Ijin Ke Yudi Jika Ingin Memasukan Bot Ke Grup Lain
6.  Penting!!!!!!! Ingat Save Nomer Owner
